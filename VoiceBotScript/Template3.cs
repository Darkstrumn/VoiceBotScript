...
//=============================================================================
namespace VoiceBotScriptTemplate3
    {
    //=========================================================================
    class Program
        {
        //---------------------------------------------------------------------
        public static void Template3(string[] args)
            {
            VoiceBotScript.Run(new IntPtr());
            }//</Template3(string[] args)>
        }/*</class::Program>*/
    //=========================================================================
//*****************************************************************************
...
/// Function: MacroScript Template and Includes Test
/// <summary>
//=============================================================================
public static class VoiceBotScript
    ...
    public static void Run(IntPtr windowHandle)
        ...
        while(bln_valid_response == false)
            {
            str_confirmation = Speech.SpeechRecognizer("");
...
public static class ScriptEngine
  ...
  public static object Eval( IntPtr windowHandle, string str_source_cs, string str_references = "")
    ...
    str_references = (str_references.Length != 0 ? str_references : SupportClasses.Constants.str_default_references);
    //
  ...
  public static object LoadInclude(IntPtr windowHandle, string str_path,string str_references = "")
    ...
    str_references = (str_references.Length != 0 ? str_references : SupportClasses.Constants.str_default_references);
    string str_include_path = (SupportClasses.Constants.str_default_includes_path + str_path + ".cs").Replace("\\\\","\\");//<<--conditioning:: undo the script compatibility conditioning of the constant = app.path\ScriptExtension\IncludeFile.cs
    //   
    try
        {
...
namespace SupportClasses
    ...
    public static class Constants
        ...
        */
        public static string str_default_includes_path = (Environment.GetEnvironmentVariable("LOCALAPPDATA")+"\\VoiceBot\\ScriptExtension\\").Replace("\\","\\\\");
        //---------------------------------------------------------------------
        }/*</class Constants>*/
    //=========================================================================
    /// <summary>
...
namespace Includes
    ...
    /// </summary>
     public static class FxLib
        ...
        static Type type_FxLib = ((Assembly)ScriptEngine.LoadInclude(new IntPtr(),"Includes_DarkLibs",SupportClasses.Constants.str_default_references)).GetTypes().Where( x => x.FullName.Contains("ScriptCore.Includes.FxLib")).ToArray<Type>()[0];
        //>>>>>appoint delagates (signatures)
        public delegate SupportClasses.Args GetArgsDelegate(String str_variable_name);
    ...
    /// </summary>
     public static class ShipModel
        {
        //>>>>>load includes, then wireup aliases to assembly
        static Type type_ShipModel = ((Assembly)ScriptEngine.LoadInclude(new IntPtr(),"Includes_EliteDangerousShipModel",SupportClasses.Constants.str_default_references)).GetTypes().Where( x => x.FullName.Contains("ScriptCore.Includes.ShipModel")).ToArray<Type>()[0];
        //>>>>>appoint delagates (signatures)
    ...
    /// </summary>
     public static class Speech
        {
        //>>>>>load includes, then wireup aliases to assembly
        static Type type_Speech = ((Assembly)ScriptEngine.LoadInclude(new IntPtr(),"Includes_DarkLibs",SupportClasses.Constants.str_default_references)).GetTypes().Where( x => x.FullName.Contains("ScriptCore.Includes.Speech")).ToArray<Type>()[0];
        //>>>>>appoint delagates (signatures)
    ...
    /// </summary>
     public static class DBS
        {
        //>>>>>load includes, then wireup aliases to assembly
        static Type type_DBS = ((Assembly)ScriptEngine.LoadInclude(new IntPtr(),"Includes_DarkLibs",SupportClasses.Constants.str_default_references)).GetTypes().Where( x => x.FullName.Contains("ScriptCore.Includes.DBS")).ToArray<Type>()[0];
        //>>>>>appoint delagates (signatures)
