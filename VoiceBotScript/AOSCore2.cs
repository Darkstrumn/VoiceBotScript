...
using System.Collections; //<<--provides hashtables
...
namespace VoiceBotScriptAOSCore
    ...
    internal class Program
        ...
        //---------------------------------------------------------------------
        public static void AOSCore(string[] args)
            {
    ...
    public static class VoiceBotScript
        ...
        */
        ...
        public static string VerbalConfirmationPrompt(ref string[] arr_arguments, int int_num_subparams, int int_expected_num)
            ...
            if ( int_num_subparams == int_expected_num )//>>>>>execute
                {
                string[] arr_str_valid_true = arr_arguments[2].Split('~');
                string[] arr_str_valid_false = arr_arguments[3].Split('~');
                string[] arr_str_retry_prompts = arr_arguments[4].Split('~');
                string str_user_response = "";
                string str_retry_prompt = arr_arguments[1];
                bool bln_quit = false;
                bool bln_valid_response = false;
                bool bln_confirmation = true;
                int int_retries = 0;
                int int_retries_left = 0;
                //
