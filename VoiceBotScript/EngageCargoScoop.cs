...
//=============================================================================
namespace VoiceBotScriptEngageCargoScoop
    {
    //=========================================================================
    internal class Program
        ...
        //---------------------------------------------------------------------
        public static void EngageCargoScoop(string[] args)
            {
            VoiceBotScript.Run(new IntPtr());
            }//</EngageCargoScoop(string[] args)>
        }/*</class::Program>*/
    ...
    public static class VoiceBotScript
        ...
        private static string str_script_name = "EngageCargoScoop";
        ...
        private static string[,] _arr_str_responses = new string[,]
                    ...
                    {/*comply verbiage*/
					"Cargo scoop engaged."
                    ,"Deploying cargo scoop."
                    ,"Sir - cargo scoop is now online."
                    ,"Acknowledged. cargo scoop active."
                    }
                    ,{/*unale to comply verbiage*/
					"Cargo Scoop is presently open and engaged."
                    ,"Commander, cargo scoop is fully deployed."
                    ,"Sir - cargo scoop is already currently online."
                    ,"Unable to comply; cargo scoop is currently active."
                    }
                    };
        ...
        public static void Run(IntPtr windowHandle)
            ...
            if ( str_cargo_scoop != "1" )
                ...
                Includes.FxLib.SaveArgs("AOSCore_ipc", ( "deployCargoScoop|SetShipState,cargoScoop,1|SendKeys,{HOME}|TTS,{TTS}".Replace("{TTS}", str_response) ).Split('|'));//<<--second param is expected to be an array
                }
